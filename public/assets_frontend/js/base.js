...
function testMode() {
    ...
    console.clear();
    console.log("%cFINAPP", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #CB1010; padding: 10px 120px; margin-bottom: 16px;")
    ...
    function testModeInfo(value, msg) {
        console.log("%c|" + "%c " + msg + " : " + "%c" + value, "color: #444; font-size :1.2em; font-weight: bold;", "color: inherit", "color:#CB1010; font-weight: bold;");
    }
