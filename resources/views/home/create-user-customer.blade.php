            ...
            <div class="card-body">
                <form action="{{ route('pos.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" placeholder="Order Name" id="order_name" class="form-control" name="order_name" required autofocus>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="email" placeholder="Order Email" id="order_email" class="form-control" name="order_email" required autofocus>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" placeholder="Nomor Telepon" id="notel" class="form-control" name="notel" required autofocus>
                        @if ($errors->has('notel'))
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" placeholder="Tanggal Order" id="tgl_order" class="form-control" name="tgl_order" required autofocus>
