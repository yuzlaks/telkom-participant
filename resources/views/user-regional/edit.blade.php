...
<div class="col-md-8">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('user-regional.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group mb-3">
                    <label for="">Name</label>
                    <input value="{{ $data->username }}" type="text" placeholder="Name" id="name" class="form-control" name="name"
                        required autofocus>
                    @if ($errors->has('name'))
                ...
                <div class="form-group mb-3">
                    ...
                    <input value="{{ $data->job_title }}" type="text" placeholder="Job Title" id="job_title" class="form-control" name="job_title"
                        required autofocus>
